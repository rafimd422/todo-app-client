...
const todosInProgress = todos.filter(todo => todo.status === 'In Progress')
  ...
  return (
    todosInProgress.map(todo => <li key={todo._id} className="w-full border border-red-500 rounded-lg p-3 md:px-5 flex justify-between items-center mb-2 shadow-lg">
    <div>
